...
PROMISED_DOWN = 150
PROMISED_UP = 10
TWITTER_EMAIL = "xyz@gmail.com"  # Twitter email
TWITTER_PASSWORD = "acd1234"  # Twitter password
...
class InternetSpeedTwitterBot:
    ...
    def tweet_at_provider(self):
        ...
        time.sleep(2)
        email = self.driver.find_element(By.XPATH, value='//*[@id="react-root"]/div/div/div[2]/main/div/div/'
                                                         'div[1]/form/div/div[1]/label/div/div[2]/div/input')
        ...
        tweet_button = self.driver.find_element(By.XPATH, value='//*[@id="react-root"]/div/div/div[2]/main/div/div'
                                                                '/div/div/div/div[2]/div/div[2]/div[1]/div/div/div/'
